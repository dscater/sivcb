...
const accionesRow = () => {
    // editar
    $("#table-marca").on("click", "button.editar", function (e) {
        e.preventDefault();
        let id = $(this).attr("data-id");
        axios.get(route("marcas.show", id)).then((response) => {
    ...
    // eliminar
    $("#table-marca").on("click", "button.eliminar", function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await deleteMarca(id);
