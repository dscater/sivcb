...
const { getSucursals, setSucursal, limpiarSucursal, deleteSucursal } =
    useSucursals();
...
const accionesRow = () => {
    // editar
    $("#table-sucursal").on("click", "button.editar", function (e) {
        e.preventDefault();
        let id = $(this).attr("data-id");
        axios.get(route("sucursals.show", id)).then((response) => {
    ...
    // eliminar
    $("#table-sucursal").on("click", "button.eliminar", function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await deleteSucursal(id);
