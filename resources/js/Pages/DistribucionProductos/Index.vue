...
const columns = [
    ...
    },
    {
        ...
        render: function (data, type, row) {
            let sucursal = `<span class="font-weight-bold">${row.sucursal.nombre}</span>`;
            return `${sucursal}`;
        },
    },
    {
...
const accionesRow = () => {
    // editar
    $("#table-distribucion_producto").on(
        "click",
        "button.editar",
        function (e) {
            e.preventDefault();
            ...
            axios
                .get(route("distribucion_productos.show", id))
                .then((response) => {
                    setDistribucionProducto(response.data);
        ...
        function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let respuesta = await deleteDistribucionProducto(id);
...
onMounted(async () => {
    datatable = initDataTable(
        "#table-distribucion_producto",
        columns,
        route("distribucion_productos.api")
    );
...
<template>
    <Head title="Distribución de productos"></Head>

    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Distribución de productos</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Distribución de productos</h1>
    <!-- END page-header -->
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table
                        id="table-distribucion_producto"
                        width="100%"
